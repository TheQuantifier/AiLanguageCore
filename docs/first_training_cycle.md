...
Use [models/v1_local_baseline_config.json](/C:/Users/jhand/Documents/Github/AiLanguageCore/models/v1_local_baseline_config.json).
...
Use [models/v1_qwen2_5_7b_qlora_config.json](/C:/Users/jhand/Documents/Github/AiLanguageCore/models/v1_qwen2_5_7b_qlora_config.json) when a CUDA-capable environment is available.
...
```powershell
& '.\.python\python.exe' scripts\train_lora.py --config models\v1_qwen2_5_7b_qlora_config.json
```
...
```powershell
& '.\.python\python.exe' scripts\evaluate_benchmark.py --model-path <run_output_dir>
```

This writes:

- `experiments/benchmark_report.json`
